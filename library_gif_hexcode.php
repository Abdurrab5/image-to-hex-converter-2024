...
if (isset($_GET['id']) && $_GET['id'] != '') {
    ...
    // SQL delete query
    $sql = "DELETE FROM library_gif_frames WHERE id = ?";
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT id, lib_id,frame_number,hex_code
                                FROM library_gif_frames
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="generate_library_gif_binary_File.php?action=download&binid=<?php echo $id; ?>" class="btn btn-sm btn-success" role="button">Binary Code</a>
                                    <a href="generate_library_gif_binary_File.php?action=download&cid=<?php echo $id; ?>" class="btn btn-sm btn-primary" role="button">C Array Code</a>
                                     </td>
                                </tr>
                        <?php
                            }
